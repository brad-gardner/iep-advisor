...
public interface IMeetingPrepService
{
    ...
    Task<ServiceResult<int>> GenerateFromGoalsAsync(int childId, int userId, DateTime? meetingDate = null, CancellationToken ct = default);
    Task<ServiceResult<int>> GenerateFromIepAsync(int iepDocumentId, int userId, DateTime? meetingDate = null, CancellationToken ct = default);
    Task<ServiceResult<int>> GenerateFromEtrAsync(int etrDocumentId, int userId, DateTime? meetingDate = null, CancellationToken ct = default);
